...
public class TVShowFragment extends Fragment {
    ...
    public void setupViewPager(ViewPager viewPager){
        mAdapter.addFragment(new Feature2Fragment(), "Features");
        mAdapter.addFragment(new TVLatestFragment2(), "Top Rate");
        mAdapter.addFragment(new TVLatestFragment(), "Japanese");
        mAdapter.addFragment(new TVLatestFragment(), "Korean");
        mAdapter.addFragment(new TVLatestFragment(), "Action");
        mAdapter.addFragment(new TVLatestFragment(), "Cartoon");
